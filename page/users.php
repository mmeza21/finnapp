                            ...
                            while ($row = mysqli_fetch_array($ejecutar)) { 
                              ...
                              <button type="button" class="editAction" data-toggle="modal" data-target="#editUsers<?php echo $idUser; ?>">
                               <i class="fas fa-user-edit"></i>
                                ...
                                <!-- Modal Editar -->
                                <div class="modal fade" id="editUsers<?php echo $idUser; ?>" tabindex="-1" role="dialog" aria-labelledby="modalEditUsers" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <form method="POST" action="../controller/getAdministration.php">
                                            <div class="modal-body">
                                                ...
                                                <option value="<?php echo $idRol; ?>" selected><?php echo $nameRol; ?></option>
                                                <?php
                                                $query = $conn->query(
                                ...
                                <!-- -->
                                <!-- Modal Registrar -->
                                <div class="modal fade" id="registerUsers" tabindex="-1" aria-labelledby="modalRegisterUsers" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                    <div class="modal-header">
