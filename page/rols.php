                ...
                <tbody>
                    <?php
                            ...
                            while ($row = mysqli_fetch_array($ejecutar)) { 
                              ...
                              <a href="/finnapp/controller/deleteRols?idRol=<?php echo $idRol; ?>" class="deleteAction"><i class="fas fa-trash-alt"></i></a>
                                ...
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <form method="POST" action="../controller/getAdministration.php">
                                        <div class="modal-body">
                                                ...
                                                <input type="text" name="txtNameRol" id="txtNameRol" class="boxText" value="<?php echo $nameRol; ?>" readonly>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="col">
                                                <label for="txtDescRol" class="lblText">Descripción</label>
                                                        <textarea name="txtDescRol" id="txtDescRol" cols="30" rows="10" class="boxTextArea" autocomplete="off"><?php echo $descRol; ?>"</textarea>
                                                    </div>
                                            </div>  
                                        </div> 
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="row">
          ...
          <input type="text" name="txtNameRol" class="boxText" autocomplete="off" required="true" placeholder="Nombre de rol">
        </div>
      </div>
      <div class="modal-footer">
      <button type="button" class="secondaryButton" data-dismiss="modal">Cerrar</button>
