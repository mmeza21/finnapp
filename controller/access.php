...
if (isset($_POST['login'])) {
  ...
  /* Consulta de acceso */
  $result = mysqli_query($conn, "select u.id_user, u.name_user, u.pass_user,u.firts_name, u.last_name, u.email_user, u.statte_user, u.id_rol, r.name_rol 
  from tbl_users u
  inner join tbl_rols r
  on
  u.id_rol = r.id_rol
  where u.name_user='". $txtUser ."' and u.pass_user='". $txtPassword ."' and u.statte_user=1");
  if ($row = mysqli_fetch_array($result)) {
    ...
    $_SESSION['statet_user'] = $row['statte_user'];
